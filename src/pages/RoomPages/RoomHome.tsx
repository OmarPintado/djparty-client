...
export const RoomHome: React.FC = () => {
    ...
    const fetchRoomDetails = async () => {
        ...
        try {
            ...
            console.error("Error al obtener los detalles de la sala:", error.message);
            setErrorMessage(error.message || "Error al obtener los detalles de la sala.");
        }
    };
        ...
        <div className="room-home-container">
            ...
            >
                <div className="room-home-header-overlay">
                    <h1 className="room-home-title">Room {roomDetails?.name || roomId}</h1>
